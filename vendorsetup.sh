...
var_not_eq(){
        echo -e "${RED_BACK}CURR_DEVICE not equal to a51 or exynos9611${RESET}"
        ...
        echo -e "${RED}Skipping universal9611(common b/w exynos9611 and a51) specific build vars...${RESET}"
}
